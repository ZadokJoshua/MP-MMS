...
namespace MP_MMS.Data.Migrations
{
    ...
    [Migration("20230705014046_PartImage")]
    partial class PartImage
    {
            ...
            modelBuilder.Entity("MP_MMS.Domain.Model.Issue", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2023, 7, 6, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2108),
                            EmployeeId = 1,
                            IsCompleted = false,
                        ...
                        new
                        {
                            ...
                            DueDate = new DateTime(2023, 7, 10, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2116),
                            EmployeeId = 2,
                            IsCompleted = true,
                        ...
                        new
                        {
                            ...
                            DueDate = new DateTime(2023, 7, 6, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2119),
                            EmployeeId = 2,
                            IsCompleted = false,
                            Name = "Tank leakage",
                            PartId = 5,
            ...
            modelBuilder.Entity("MP_MMS.Domain.Model.Part", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Actuator",
                            DateAdded = new DateTime(2023, 7, 5, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2028),
                            LocationId = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Others",
                            DateAdded = new DateTime(2023, 7, 5, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2046),
                            LocationId = 3,
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Others",
                            DateAdded = new DateTime(2023, 7, 5, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2050),
                            LocationId = 3,
                            Manufacturer = "Fiberglass Engineering",
                            ModelNumber = "WWG-2F",
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Belt",
                            DateAdded = new DateTime(2023, 7, 5, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2054),
                            LocationId = 2,
                            Manufacturer = "McMaster Engineering Limited",
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Others",
                            DateAdded = new DateTime(2023, 7, 5, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2057),
                            LocationId = 1,
                        ...
                        new
                        {
                            Id = 6,
                            Category = "Bearing",
                            DateAdded = new DateTime(2023, 7, 5, 2, 40, 44, 562, DateTimeKind.Local).AddTicks(2062),
                            LocationId = 2,
                            Manufacturer = "McMaster Engineering Limited",
                            ModelNumber = "N/A",
